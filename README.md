# Wikipedia-clone
Wikipedia clone using Django web framework.

This project is an Assigment of an online course called CS50w- Web programming with Django and Javascript.

This project Satisfies all the specifications of the assignment i.e:
